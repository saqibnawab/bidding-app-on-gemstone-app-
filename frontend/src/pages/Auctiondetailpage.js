...
//     console.log("yesohhhhhhhhhhh ", bid);
...
//         // Remove _id from singelauctiondetail
//         const updatedData = { ...singelauctiondetail }; // Create a shallow copy
//         delete updatedData._id; // Remove _id from the copied object

//         // Add bid price to updatedData
//         updatedData.bidprice = bid;
//         updatedData.email = user.email;
//         updatedData.username = user.name;

//         console.log("updated data", updatedData);

//         axios.post("http://localhost:5000/biddingprice", { updatedData })
//             .then((res) => {
//                 console.log(res);
...
//                                 <Button variant="contained" sx={{ mx: 'auto', width: 400 }} onClick={placebid}>Place A Bid</Button>
...
//                                             maxRows={8}
//                                         />
//                                         <Button variant="contained" sx={{ mx: 'auto', width: 200 }} onClick={() => placebid()}>Submit</Button>
