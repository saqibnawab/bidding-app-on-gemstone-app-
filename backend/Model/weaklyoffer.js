...
// Define the schema
const weaklyOfferSchema = new mongoose.Schema({
    name: {
        type: String,
        required: true,
    },
...
weaklyOfferSchema.pre('save', function (next) {
...
const WeaklyOffer = mongoose.model('WeaklyOffer', weaklyOfferSchema);
module.exports = WeaklyOffer;
